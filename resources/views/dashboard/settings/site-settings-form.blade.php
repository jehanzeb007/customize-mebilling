    ...
    <div class=" default-height">
        <div class="container-fluid">
            <div class="page-titles">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('admin.settings.settingpagelist')}}">Setting</a></li>
                    <li class="breadcrumb-item active"><a href="javascript:void(0)">Add Settings</a></li>
                </ol>
            </div>
            <!-- Row -->
            <div class="row">
