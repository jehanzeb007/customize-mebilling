                                        ...
                                        <div class="card text-center">
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex align-items-center justify-content-center">
                                                    ...
                                                    <span
                                                        class="fs-14 d-block ms-2 pe-2 me-2 border-end text-black font-w500">4.4</span>
                        ...
                        <div class="card featuredMenu">
                            ...
                            <div class="card-body loadmore-content height700 dz-scroll pt-0" id="FeaturedMenusContent">
                                <div class="media mb-4">
                                    <img src="{{ asset('assets/images/menus/1.png') }}" width="85" alt=""
                                        class="rounded me-3">
                                    <div class="media-body">
                                ...
                                <ul class="d-flex flex-wrap pb-2 border-bottom mb-3 justify-content-between">
                                    ...
                                    <li class="mb-2"><i class="fa-regular fa-star me-2 scale1 text-warning"
                                            aria-hidden="true"></i><span class="fs-14 text-black font-w500">176
                                            Reviews</span></li>
                                </ul>
                                <div class="media mb-4">
                                    <img src="{{ asset('assets/images/menus/2.png') }}" width="85" alt=""
                                        class="rounded me-3">
                                    <div class="media-body">
                                ...
                                <div class="media mb-4">
                                    <img src="{{ asset('assets/images/menus/3.png') }}" width="85" alt=""
                                        class="rounded me-3">
                                    <div class="media-body">
                                        <h5><a href="food-menu.html" class="text-black fs-16">Fresh or Frozen (No Sugar
                                                Added) Fruits</a></h5>
                                ...
                                <div class="media mb-4">
                                    <img src="{{ asset('assets/images/menus/4.png') }}" width="85" alt=""
                                        class="rounded me-3">
                                    <div class="media-body">
