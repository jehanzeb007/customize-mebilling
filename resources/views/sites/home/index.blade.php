...
@section('content')
    <main>
                                ...
                                <div class="col-lg-6">
                                    <div class="slider-content s-slider-content text-left">
                                        ...
                                        <div class="slider-btn mt-25">
                                            <a href="{{asset('/about_us')}}"  class="btn ss-btn" data-animation="fadeInRight" data-delay=".8s">Learn More <i class="fas fa-chevron-right"></i></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
        ...
        <section class=" cta-bg  pt-100 pb-0 fix">
            ...
            <div class="solutuons-wrapper mt-5 mb-5">
                <div class="container">
                    <div class="inner">
                        ...
                        <div id="core-objectives" class="owl-carousel owl-solution owl-theme owl-loaded owl-drag">
                            <div class="owl-stage-outer">
                                <div class="owl-stage"
                                    style="transform: translate3d(-2292px, 0px, 0px); transition: all; width: 9168px;">
                                    <div class="owl-item">
                                        <div class="solution-carousel-wrapper">
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col-12 col-md-6">
                                                    <div class="image-wrapper image-set">
                                                        <img src="{{ asset('assets/images/verification.jpg') }}"
                                                            alt="">
                                                    </div>
                                                </div>
                                    ...
                                    <div class="owl-item fade-out-up inactive cloned">
                                        <div class="solution-carousel-wrapper">
                                            <div class="row align-items-center">
                                                <div class="col-12 col-md-6">
                                                    <div class="content">
                                                ...
                                                <div class="col-12 col-md-6">
                                                    <div class="image-wrapper image-set">
                                                        <img src="{{ asset('assets/images/insurance.jpg') }}"
                                                            alt="">
                                                    </div>
                                                </div>
                                    ...
                                    <div class="owl-item animated owl-animated-in fadeIn fade-in-up active">
                                        <div class="solution-carousel-wrapper">
                                            <div class="row align-items-center">
                                                <div class="col-12 col-md-6">
                                                    <div class="content">
                                                ...
                                                <div class="col-12 col-md-6">
                                                    <div class="image-wrapper image-set">
                                                        <img src="{{ asset('assets/images/Credentaling.jpg') }}"
                                                            alt="">
                                                    </div>
                                                </div>
                                    ...
                                    <div class="owl-item fade-out-up inactive">
                                        <div class="solution-carousel-wrapper">
                                            <div class="row align-items-center">
                                                <div class="col-12 col-md-6">
                                                    <div class="content">
                                                ...
                                                <div class="col-12 col-md-6">
                                                    <div class="image-wrapper image-set">
                                                        <img src="{{ asset('assets/images/enrollment.jpg') }}"
                                                            alt="">
                                                    </div>
                                                </div>
                                    ...
                                    <div class="owl-item fade-out-up inactive">
                                        <div class="solution-carousel-wrapper">
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col-12 col-md-6">
                                                    <div class="image-wrapper image-set">
                                                        <img src="{{ asset('assets/images/scheduling.jpg') }}"
                                                            alt="">
                                    ...
                                    <div class="owl-item fade-out-up inactive">
                                        <div class="solution-carousel-wrapper">
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col-12 col-md-6">
                                                    <div class="image-wrapper image-set">
                                                        <img src="{{ asset('assets/images/reminder.jpg') }}"
                                                            alt="">
                                                    </div>
                                                </div>
                                    ...
                                    <div class="owl-item animated owl-animated-in fadeIn fade-in-up cloned">
                                        <div class="solution-carousel-wrapper">
                                            <div class="row align-items-center">
                                                <div class="col-12 col-md-6">
                                                    <div class="content">
                                                        ...
                                                        <p class="subtitle mb-3">
                                                            Choose us for unparalleled accuracy, efficiency, and
                                                            increased
                                                            revenue with our advanced AI-driven medical billing
                                                            solutions.
                                                        </p>
                                                ...
                                                <div class="col-12 col-md-6">
                                                    <div class="image-wrapper image-set">
                                                        <img src="{{ asset('assets/images/assesment.jpg') }}"
                                                            alt="">
                                                    </div>
                                                </div>
        ...
        <section class="mt-5 p-0 mb-5">
            <div class="container">
                ...
                <div id="processSection" class="row justify-content-center">
